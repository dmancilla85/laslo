...
public class LoopCatcherOld {
    ...
    public LoopCatcherOld(String pathOut, String pathIn,
            ...
            for (File currentFile : fileList) {
                if (currentFile.isFile()
                    ...
                    try {
                        ...
                        Logger.getLogger(LoopCatcherOld.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (Exception ex) {
                        Logger.getLogger(LoopCatcherOld.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public void processFile() {
        ...
        try {
            ...
            /*Logger.getLogger(LoopCatcherOld.class.getName())
